...
1. **Download the code**: Either run `git clone https://github.com/[YOUR-USERNAME]/civicgrid-ai.git` or download the project as a ZIP file from GitHub and extract it.
